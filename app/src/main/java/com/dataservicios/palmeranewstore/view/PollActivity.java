package com.dataservicios.palmeranewstore.view;
...
import com.dataservicios.palmeranewstore.R;
import com.dataservicios.palmeranewstore.db.DatabaseManager;
import com.dataservicios.palmeranewstore.model.AuditRoadStore;
import com.dataservicios.palmeranewstore.model.Company;
import com.dataservicios.palmeranewstore.model.Media;
import com.dataservicios.palmeranewstore.model.Poll;
import com.dataservicios.palmeranewstore.model.PollDetail;
import com.dataservicios.palmeranewstore.model.PollOption;
import com.dataservicios.palmeranewstore.model.Route;
import com.dataservicios.palmeranewstore.model.RouteStoreTime;
import com.dataservicios.palmeranewstore.model.Store;
import com.dataservicios.palmeranewstore.repo.AuditRoadStoreRepo;
import com.dataservicios.palmeranewstore.repo.CompanyRepo;
import com.dataservicios.palmeranewstore.repo.PollOptionRepo;
import com.dataservicios.palmeranewstore.repo.PollRepo;
import com.dataservicios.palmeranewstore.repo.RouteRepo;
import com.dataservicios.palmeranewstore.repo.RouteStoreTimeRepo;
import com.dataservicios.palmeranewstore.repo.StoreRepo;
import com.dataservicios.palmeranewstore.util.AuditUtil;
import com.dataservicios.palmeranewstore.util.GPSTracker;
import com.dataservicios.palmeranewstore.util.SessionManager;
        ...
        switch (orderPoll) {
            ...
            case 2:
                if(isYesNo==1) {
                    ...
                    String optionExcexption = poll.getId() + "f";
                    if(selectedOptions.equals(optionExcexption)){
                        poll.setOrder(3);
                        PollActivity.createInstance(activity, store_id,audit_id,poll);
                        finish();
                    } else {
        ...
        switch (orderPoll) {
            ...
            case 2:
                ...
                swYesNo.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                    @Override
                    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                        if(isChecked) showPollOptionsControl(true); else showPollOptionsControl(true);
                    }
                });
                break;
